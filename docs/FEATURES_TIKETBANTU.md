...
> **Note**: Admin fokus 100% pada fungsi **Monitoring & Pengelolaan Sistem** tanpa terlibat dalam penugasan agen secara manual. SLA Tracker dihapus.
...
| #   | Fitur                                   | Prioritas | Role  | Deskripsi |
| --- | --------------------------------------- | --------- | ----- | --------- |
| 6.1 | Email Notification Perubahan Status     | 🔴 P0     | U/G   | Pengiriman notifikasi email otomatis ke Pelapor saat status aduan diperbarui |
| 6.2 | Toast Notification UI                   | 🔴 P0     | A/G/U | Notifikasi melayang (*Toast*) saat berhasil claim tiket, update status, atau kirim komentar |
| 6.3 | Push Notification Mobile (Planned)      | 🟢 P2     | A/G/U | Notifikasi aplikasi mobile untuk versi pengembangan selanjutnya |

---

## 7. 🛠️ Modul Pengaturan & Sistem (Non-UI)

| #    | Fitur                                  | Prioritas | Deskripsi |
| ---- | -------------------------------------- | --------- | --------- |
| 7.1  | Database Migrations & Seeders          | 🔴 P0     | Skema tabel terstruktur MySQL (`users`, `tickets`, `categories`, `comments`, `attachments`, `ticket_supports`) |
| 7.2  | Middleware Auth & Role Authorization   | 🔴 P0     | Keamanan rute berbasis peran (Pelapor `user`, Agen `agent`, Admin `admin`) |
| 7.3  | File Upload Security & Mimes Check     | 🔴 P0     | Validasi mime types lampiran (JPG, JPEG, PNG, PDF, DOC, DOCX, ZIP, TXT) |
| 7.4  | Dynamic Badge UI Helpers               | 🔴 P0     | Helper rendering badge status dinamis (Termasuk Badge Centang Hijau untuk `Selesai`) |
| 7.5  | Realtime Polling Engine (Livewire)     | 🟡 P1     | Polling komentar dan counter dukungan "Saya Juga Mengalami" secara realtime |
| 7.6  | Database Backup Script                 | 🟡 P1     | Otomatisasi backup berkala database MySQL |
...
| --------- | ------------ | ------------------------------ |
| 🔴 P0     | ~35 fitur    | MVP — Core Helpdesk Functionality |
| 🟡 P1     | ~10 fitur    | Post-MVP — Enhancements & Analytics |
| 🟢 P2     | ~4 fitur     | Future — Mobile Push Notifications & Deep Links |
...
- Pure Monitoring Dashboard untuk Admin (Tanpa SLA)
- Email Notification
...
- Image Compression & Deep Linking Notification
